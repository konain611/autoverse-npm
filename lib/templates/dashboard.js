...
const styles = {
  ...
  brand: { display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '12px 12px', borderBottom: '1px solid #1a1a1a', gap: '8px' },
  brandLeft: { display: 'flex', alignItems: 'center', gap: '10px', minWidth: 0 },
  brandLogo: { width: '34px', height: '34px', borderRadius: '9px', objectFit: 'cover', flexShrink: 0 },
  ...
  logoutBtn: { display: 'flex', alignItems: 'center', gap: '12px', padding: '10px 12px', borderRadius: '8px', border: '1px solid #3a1111', cursor: 'pointer', fontSize: '14px', background: '#1f0b0b', color: '#ff5c5c', width: '100%' },
