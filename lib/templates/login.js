...
export default function AutoverseDashboardLogin() {
  ...
  const AGENT_NAME =
    ...
    'Autoverse';
  const USERNAME =
    getPublicEnv('NEXT_PUBLIC_AUTOVERSE_USERNAME') ||
    getPublicEnv('VITE_AUTOVERSE_USERNAME') ||
    getPublicEnv('REACT_APP_AUTOVERSE_USERNAME');
  const PASSWORD =
    getPublicEnv('NEXT_PUBLIC_AUTOVERSE_PASSWORD') ||
    getPublicEnv('VITE_AUTOVERSE_PASSWORD') ||
    getPublicEnv('REACT_APP_AUTOVERSE_PASSWORD');
